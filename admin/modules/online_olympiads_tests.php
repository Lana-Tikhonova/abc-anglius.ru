...
$form[2][] = '<div class="clear"></div>';
$form[2][] = '<input type="file" name="csv">';
//$form[3][]=
...
//
$content .= '<style type="text/css">' . file_get_contents(ROOT_DIR . 'admin/templates/onlymp/onlimp.css') . '</style>';
$content .= '<script src="/plugins/PapaParse-master/papaparse.min.js"></script>'
    . '<script type="text/javascript"> ' . file_get_contents( ROOT_DIR . 'admin/templates/onlymp/onlimp.js') . '</script>'
