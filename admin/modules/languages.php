...
$form[0][] = lang_form('input td12','common|smi','текст над меню');
/*
...
$form[0][] = lang_form('textarea td12','common|pedagog_txt','текст перед онлайн олимп. пердагогов');
$form[0][] = lang_form('input td12','common|olimp_category_empty','без категории');
...
$form[1][] = lang_form('input td12','common|olimp_see_all','смотреть все');
$form[1][] = lang_form('input td12','common|olimp_accept','принять участин');
$form[1][] = lang_form('input td12','common|olimp_accept2','пройти тест');
