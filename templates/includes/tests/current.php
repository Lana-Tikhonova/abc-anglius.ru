<?php $current=$q[intval(explode2('-',$u[2]))];?>
  <div class='bigimg'>
    <div class='container'>
      <img src='/files/tests/<?=$current['id']?>/img/m-<?=$current['img']?>'>
      <div class='txt'>
        ...
        <div class='block' style='background-image:url(/templates/images/sandclock.png)'>
          <div class='table'>
            <div class='tr'>
              ...
              <div class='td' style='width:345px;'><?=i18n('common|tests_period1')?>.</div>
            </div>
            <div class='tr'>
              <div class='td'><b>ПОДВЕДЕНИЕ ИТОГОВ</b></div>
              <div class='td'><?=i18n('common|tests_period2')?>.</div>
            </div>
          </div>
        </div>
