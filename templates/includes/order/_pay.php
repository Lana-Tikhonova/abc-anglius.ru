...
?>
      <div class="poblock">
      <a href="https://money.yandex.ru/eshop.xml?shopId=<?=$config['yandex_shopId']?>&scid=<?=$config['yandex_scid']?>&sum=<?=$q['total']?>&customerNumber=<?=$config['yandex_customerNumber']?>&orderNumber=<?=$q['id']?>&paymentType=<?=$v['yk']?>">
