...
if($order) {
	...
	if ($number==='0' && $pedagog === '0') {		//var_dump($basket); die();
		...
		textinblock($img,$color2,$font3_path_i,93,$basket['director'],array('x'=>327,'y'=>1230,'w'=>1832,'h'=>0,'h_align'=>'center','v_align'=>'top'));
		...
		textinblock($img,$color4,$font_path,31,date2(($order['date_paid']!=0?$order['date_paid']:$order['date']),'d month y').' года           /           Anglius.ru',array('x'=>327,'y'=>3190,'w'=>1832,'h'=>0,'h_align'=>'center','v_align'=>'top'),false);
                ...
                //textinblock($img,$color1,$font_path,31,'Проверка диплома: '.$current_link,array('x'=>200,'y'=>3150,'w'=>2080,'h'=>0,'h_align'=>'center','v_align'=>'top'),false);			
	} else {
	    switch($basket['template']) {
		    ...
		    default:
			    ...
			    if(isset($basket['kk'])) textinblock($img,$color2,$font_path,40,stripcslashes($basket['kk']),array('x'=>200,'y'=>2000,'w'=>2080,'h'=>0,'h_align'=>'center','v_align'=>'top'));
			    //textinblock($img,$gold,$font_path,43,$basket['workplace'],array('x'=>465,'y'=>2365,'w'=>1550,'h'=>0,'h_align'=>'left','v_align'=>'top'));
			    textinblock($img,$color2,$font_path,40,$basket['workplace'],array('x'=>200,'y'=>2135,'w'=>2080,'h'=>0,'h_align'=>'center','v_align'=>'top'));
			    ...
			    textinblock($img,$color1,$font_path,31,'регистрационный номер диплома № ONL-'.$order['id'],array('x'=>200,'y'=>2600,'w'=>2080,'h'=>0,'h_align'=>'right','v_align'=>'top'));
			    ...
			    textinblock($img,$color1,$font_path,31,date2($order['date'],'d month y').' года           /           Anglius.ru',array('x'=>327,'y'=>3190,'w'=>1832,'h'=>0,'h_align'=>'center','v_align'=>'top'),false);
				// [4.31] Ссылка на диплом
                //textinblock($img,$color1,$font_path,31,'Проверка диплома: '.$current_link,array('x'=>200,'y'=>3150,'w'=>2080,'h'=>0,'h_align'=>'center','v_align'=>'top'),false);	
