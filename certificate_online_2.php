...
if($order) {
	...
	switch($basket['template']) {
		...
		default:
			...
			textinblock($img,$color2,$font_path,90,$basket['f'].' '.$basket['io'],array('x'=>240,'y'=>1757,'w'=>2000,'h'=>0,'h_align'=>'center','v_align'=>'top'));
			//if(isset($basket['kk'])) textinblock($img,$gold,$font_path,43,$basket['kk'],array('x'=>465,'y'=>2265,'w'=>1850,'h'=>0,'h_align'=>'center','v_align'=>'top'));			
			if(isset($basket['kk'])) textinblock($img,$black,$font_path,43,stripcslashes($basket['kk']),array('x'=>240,'y'=>2030,'w'=>2000,'h'=>0,'h_align'=>'center','v_align'=>'top'));
			//textinblock($img,$gold,$font_path,43,$basket['workplace'],array('x'=>465,'y'=>2365,'w'=>1550,'h'=>0,'h_align'=>'left','v_align'=>'top'));
			textinblock($img,$black,$font_path,38,$basket['workplace'],array('x'=>240,'y'=>2140,'w'=>2000,'h'=>0,'h_align'=>'center','v_align'=>'top'));
			if(isset($basket['director'])&&$basket['director']!='')
			textinblock($img,$black,$font_path,38,'Руководитель: '.$basket['director'],array('x'=>327,'y'=>2300,'w'=>1832,'h'=>0,'h_align'=>'center','v_align'=>'top'));
			textinblock($img,$color1,$font_path,31,'регистрационный номер диплома № ONL-'.$order['id'],array('x'=>327,'y'=>2529,'w'=>1832,'h'=>0,'h_align'=>'center','v_align'=>'top'));
